    ...
    <div class="p-4 my-16 sm:ml-64">
        <div class="p-8 bg-gray-100 rounded-lg shadow-lg max-w-3xl">
            ...
            <form class="w-3xl mt-8" action="/send-custom-email" method="POST">
                ...
                {{-- input email --}}
                <div class="mb-5">
                    <label for="subject" class="block mb-2 text-lg font-medium text-gray-900 dark:text-black">Subjek</label> <input type="text" id="subject" name="subject" class="bg-gray-50 border border-black text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Subjek" required />
                </div>
    
                {{-- input pesan --}}
                <div class="mb-4">
                    <label for="message" class="block mb-2 text-lg font-medium text-gray-900 dark:text-black">Masukan Pesan</label> <input id="message" type="hidden" name="message">
                    <trix-editor input="message" class="trix-content h-8 mb-3 max-w-3xl border border-black rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-white"></trix-editor>
                </div>
