                ...
                <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="mt-5">
                                <h5 class="leading-none text-3xl text-gray-900 dark:text-white pb-2"><span class="font-bold">100</span> <span class="text-xl">Pcs</span></h5>
                                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Jumlah Produk</p>
                            </div>
                        </div>
                        <div class="flex mt-8 items-center px-2.5 py-0.5 text-base font-semibold text-green-500 dark:text-green-500 text-center">
                            12%
                ...
                <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="mt-5">
                                <h5 class="leading-none text-3xl text-gray-900 dark:text-white pb-2"><span class="font-bold">100</span> <span class="text-xl">Users</span></h5>
