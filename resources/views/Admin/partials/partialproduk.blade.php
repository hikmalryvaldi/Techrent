@foreach ($products as $index => $product)
    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td class="px-6 py-4">
            ...
            <!-- Button Hijau-->
            <button action="{{ route('produk.edit', $product->id) }}" data-modal-target="crud-modal-{{ $product->id }}"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <button type="button" data-modal-hide="crud-modal-{{ $product->id }}"
                        ...
                        <form action="{{ route('produk.update', $product->id) }}" method="POST"
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="relative flex items-center max-w-[8rem]">
                                        ...
                                        <input type="text" id="stock-{{ $product->id }}" name="stock"
                                            data-input-counter
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="flex flex-col gap-4 items-center justify-center w-full col-span-2 p-5">
                                    @foreach ($product->images as $image)
                                        <label for="image_1"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                @if ($image->image_path1)
                                                    <img src="{{ asset('storage/' . $image->image_path1) }}"
                                                        alt="Image 1" class="w-32 h-32 object-cover mb-4 rounded-lg">
                                                @else
                                            ...
                                            <input id="image_1" name="image_path1" type="file" />
                                        </label>
                                        <label for="image_2"
                                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            ...
                                            <input id="image_2" name="image_path2" type="file" />
                                        </label>
                                        <label for="image_3"
                                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            ...
                                            <input id="image_3" name="image_path3" type="file" />
                                        </label>
                                        <label for="image_4"
                                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                @if ($image->image_path4)
                                                    <img src="{{ asset('storage/' . $image->image_path4) }}"
                                                        alt="Image 4" class="w-32 h-32 object-cover mb-4 rounded-lg">
                                                @else
                                                    <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400"
                                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                        fill="none" viewBox="0 0 20 16">
                                            ...
                                            <input id="image_4" name="image_path4" type="file" />
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            {{-- button Edit --}}
                            <button type="button" data-modal-target="popup-modal-{{ $product->id }}"
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <div class="flex justify-center gap-4">
                                <form action="{{ route('produk.destroy', $product->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button data-modal-hide="popup-Delete-{{ $product->id }}" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                        Yes, I'm sure
                                    </button>
                                </form>
                                <button data-modal-hide="popup-Delete-{{ $product->id }}" type="button"
                                    class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">No,
                                    cancel</button>
                            </div>
                        </div>
