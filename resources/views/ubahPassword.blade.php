...
<body>
    ...
    <div class="max-w-4xl mx-auto py-12 px-6 sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="flex items-center gap-2 -mt-3">
                            <label
                                ...
                                <input type="password" class="input-pass input-field w-full" placeholder="Password Saat Ini"
                                    id="oldpassword" name="oldpassword" required>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-show hidden size-6 cursor-pointer">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                      </svg>
                                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-hide size-6 cursor-pointer">
                        ...
                        <div class="flex items-center gap-2 mt-8">
                            <label
                                ...
                                <input type="password" class="input-pass input-field w-full" placeholder="Password Baru" id="newpassword" name="newpassword" required>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-show hidden size-6 cursor-pointer">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                  </svg>
                        ...
                        <div class="flex items-center gap-2 mt-8">
                            <label
                                ...
                                <input type="password" class="input-pass input-field w-full" placeholder="Masukkan Lagi Password"
            ...
            <script src="{{ asset('js/ubahPassword.js') }}"></script>
</body>
