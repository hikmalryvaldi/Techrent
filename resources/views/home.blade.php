...
<div class="flex-grow flex items-center justify-center px-4">
    <div
      class="w-full max-w-4xl h-auto bg-[#637188] text-white flex flex-wrap items-center justify-center md:justify-between mt-10 p-6  rounded-lg shadow-lg"
    >
      <div class="kata w-full md:w-1/2 mb-4 md:mb-0">
        <p class="text-xl md:text-4xl text-center md:text-center font-bold ">
          Dapatkan Teknologi Terbaru Tanpa Membeli
        </p>
      </div>
  
      <img
        src="{{ asset('img/speaker.png') }}"
        alt="Speaker"
        class="w-full max-w-[200px] md:max-w-[300px] h-auto object-cover rounded-lg"
      />
    </div>
  </div>
